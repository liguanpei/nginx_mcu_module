#define NGX_CONFIGURE " --prefix=/var/www/dream/nginx-pull-record/ --add-module=./src/nginx-rtmp-module --with-debug --with-cc-opt='-g -O0'"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/var/www/dream/nginx-pull-record//"
#endif
